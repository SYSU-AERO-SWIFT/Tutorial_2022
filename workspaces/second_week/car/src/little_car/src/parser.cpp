...
SVector3 l_car::get_velocity()
{
	return this->_velocity;
}

SVector3 l_car::get_position()
{
	return this->_position;
}
void l_car::set_velocity(SVector3 velocity)
{
...
void l_car::set_noise_level(int level)
{
	_noise_level = level;
}
void l_car::update_position()
{
